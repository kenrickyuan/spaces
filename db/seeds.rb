...
10.times do |i|
  ...
  space = Space.new(
    owner: user,
    description: "A beautiful space. Perfectly situated a block from Central Park, Columbus Circle, Time Warner Center, Whole Foods, Equinox Gym and multiple 5-star dining options. All major subway lines (A,B,C,D,E,N,Q,R,W and 1) are right there! Guests have access to all facilities, including wifi!",
    location: "New York",
    category: categories.sample(3),
